...
class YOLOXFaceHead(YOLOXHead):
    ...
    def forward(self, xin, labels=None, imgs=None, boost_face_from_body_thold=0):
        outputs = []
        origin_preds = []
        x_shifts = []
        y_shifts = []
        ...
        for k, (reg_conv, stride_this_level, x) in enumerate(
            ...
            if self.training and not boost_face_from_body_thold > 0:
            ...
            elif self.training and boost_face_from_body_thold > 0:
                output = torch.cat([reg_output, obj_output], 1)  
            else:
        ...
        if self.training and not boost_face_from_body_thold > 0:
            ...
            return self.boost_loss(outputs, labels, 
                                   boost_face_from_body_thold, boost_face=True)
