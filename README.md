...
- **Description:** Original Training Repository of the Paper: "[Domain-Adaptive Self-Supervised Pre-training for Face &amp; Body Detection in Drawings](https://arxiv.org/abs/2211.10641)"
...
You can find all the pre-trained model weights from [here](https://drive.google.com/drive/folders/14HJEg681oM1Lma2m0J0ljKDYag74mquj?usp=sharing). Please note that: 
